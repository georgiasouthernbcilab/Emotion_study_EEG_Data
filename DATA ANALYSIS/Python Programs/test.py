...
file_path = 'dictionaryoutput2.txt'
...
try:
    with open('dictionaryoutput2.txt', 'r') as file:
...
#dictionary for total occurences:
...
# sorted_experiment_values = sorted(experiment_values.items(), key=lambda item: float(item[1]))

# dict(sorted_experiment_values)

# print(sorted_experiment_values)
...
for key, inner_dict in (experiment_values.items()):
    ...
    with open('testsorting.txt', 'w') as file:
    ...
    for location, value in sorted_inner_dict.items():
        ...
        # beta_h_dict.clear()
        # gamma_dict.clear()
        # for location, value in inner_dict.items():
        ...
        if 'Alpha' in location:
            ...
            gamma_locations[location] = value
...
with open('alpha_max_counts.csv','a') as file:
...
with open('beta_l_max_counts.csv','a') as file:
    for i in beta_l_locations:
        print(i,',',beta_l_locations[i],file=file)

with open('beta_h_max_counts.csv','a') as file:
    for i in beta_h_locations:
        print(i,',',beta_h_locations[i],file=file)
        
with open('gamma_max_counts.csv','a') as file:
