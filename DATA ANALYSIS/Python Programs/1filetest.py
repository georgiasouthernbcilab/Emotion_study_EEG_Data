...
# Assign directory
directory = '2_ATTENTION\\013127\\split'
output_directory = '01317\\processed_data'
...
#%% 
        ...
        with open(str(filename) + 'dictionaryoutput.txt', 'w') as file:
            print(file)
            # Redirect the print statement to write to the file
            print(row_dictionaries, file=file)